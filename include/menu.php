    ...
    <ul class="nav navbar-nav">
      <li class="dropdown dropdown-fw  ">
          <a href="javascript:;" class="text-uppercase">
              <i class="icon-home"></i> Absensi </a>
          <ul class="dropdown-menu dropdown-menu-fw">
              <li>
                  <a href="?cat=absensi&page=inputabsensisantri">
                      <i class="icon-bar-chart"></i> Input Absensi Siswa </a>
              </li>
              <li>
                  <a href="dashboard_2.html">
                      <i class="icon-bulb"></i> Input Absensi Guru  </a>
              </li>
              <li>
                  <a href="dashboard_3.html">
                      <i class="icon-graph"></i> Rekap Absensi Harian </a>
              </li>
          </ul>
      </li>
