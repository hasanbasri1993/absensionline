...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="login.php?login_attempt=1" method="post">
            ...
            <form class="forget-form" action="login.php?login_attempt=1" method="post">
...
{
	$spf=sprintf("Select * from guru
				  where username='%s' and password='%s'",$_POST['username'],$_POST['password']);
	$rs=mysql_query($spf);
...
if($tahunsemster === FALSE) {
    ...
    //header("Location: https://reguler.zenziva.net/apps/smsapi.php?userkey=56yh2d&passkey=hjve6uly&nohp=082213542319&pesan=telah%20login ".$rw['nama_guru']."");
